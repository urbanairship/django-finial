...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserTemplateOverride'
        db.create_table('finial_usertemplateoverride', (
    ...
    def backwards(self, orm):
        # Deleting model 'UserTemplateOverride'
        db.delete_table('finial_usertemplateoverride')
